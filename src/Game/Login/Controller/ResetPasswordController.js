var ResetPasswordController = BaseController.extend({
    ...
    createView:function(){
        this.m_logic= ResetPasswordLogic;
    ...
    addCallback:function(){
        this.addEvent("btn_cancel", this.m_logic.m_view, this.m_logic.onBtn_cancelEvent);
//        this.addEvent("txt_username", this.m_logic.m_view, this.m_logic.onTxt_usernameEvent);
//        this.addEvent("txt_phonenum", this.m_logic.m_view, this.m_logic.onTxt_phonenumEvent);
        this.addEvent("btn_commit", this.m_logic.m_view, this.m_logic.onBtn_commitEvent);
