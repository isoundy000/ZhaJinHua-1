var DeleteUserController = BaseController.extend({
    ...
    addCallback:function(){
        this.addEvent("btn_close", this.m_logic.m_view, this.m_logic.onBtn_CancelEvent);
        this.addEvent("btn_go", this.m_logic.m_view, this.m_logic.onBtn_OkEvent);
    },
